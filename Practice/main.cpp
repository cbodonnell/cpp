...
void display_num(int num) // Displays the number you chose and whether it is a large number or not and whether
                          // it is even or not.
{
...
int main() // All programs must have a main function. Program begins with this function.
{
